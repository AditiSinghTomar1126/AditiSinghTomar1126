...
I design and engineer production-ready web architectures. Obsessed with high-performance JavaScript, clean async backend systems, and modern frontend design patterns.

---

###  The Stack & Dev Ecosystem

**Core JavaScript & Languages**
...
* **[KrishiBazar](https://github.com/AditiSinghTomar1126/krishibazar)** — An end-to-end agritech marketplace platform built with the MERN stack to connect farmers directly with buyers, featuring real-time product listings, trade workflows, and resilient database queries.
* **[ATNexus](https://github.com/AditiSinghTomar1126/atnexus)** — A scalable full-stack networking and data management hub engineered with secure authentication, modular REST APIs, and dynamic state handling.
*
